 ...
 */
public class MainProcessorTest2 implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        Element element = page.getHtml().getDocument().getElementById("ip_list");
        ...
        for (int i = 1; i < elements.size(); i++) {
            ...
            for(int j = 1; j < tds.size(); j++){
                ...
                Element temp = td.getElementsByTag("img").first();
                if(temp != null){
                    text = temp.attr("alt");
                }
                temp = td.getElementsByTag("div").first();
                if(temp != null){
...
//            int r = (int)(Math.random()*200+1);
        ...
        TxtUtil.writeTxt("C:\\Users\\issuser\\Desktop\\ip2.txt",sb.toString()+sb2.toString());
