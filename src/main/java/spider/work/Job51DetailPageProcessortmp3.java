...
public class Job51DetailPageProcessortmp3 implements PageProcessor {
    ...
    public static void main(String[] args) {
        List<String > list = TxtUtil.readTxt("C:\\Users\\issuser\\Desktop\\tmp3.txt");
        for(int i =100;i<200;i++){
            String path = list.get(i);
            Spider.create(new Job51DetailPageProcessortmp3()).addUrl(path).thread(5).run();
        }
