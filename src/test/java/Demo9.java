...
//        System.out.println();
        String str = format.format(new Integer(sdf.format(new Date())))+".00";
        if(!str.contains(".00")||!str.contains(",")){
//            System.out.println(123);
        }
        String strTmp = format.format(new Integer(sdf.format(new Date())))+".00";
        System.out.println(strTmp);
//        System.out.println(isNumeric(str.replaceAll(",","")));
        System.out.println(isNumeric(str.replaceAll(",","").replaceAll(".","")));
    }
